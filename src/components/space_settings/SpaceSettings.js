...
const fetchBundleVersions = (options = {}) => {
  return localAxios
    .get(
      `https://s3.amazonaws.com/kinops.io?list-type=2&prefix=bundles/${
        options.name || 'kinetic'
      }/${options.branches ? 'branches' : 'releases'}/&delimiter=/`,
    )
    .then(response => {
        ...
        .map(path => {
          ...
          if (match && !options.branches) {
            ...
            return {
              ...
              value: `https://s3.amazonaws.com/kinops.io/bundles/${
                options.name || 'kinetic'
              }/releases/${match[1]}/index.html`,
              sort,
            };
      ...
      ({ space }) =>
        space && [
          ...
          },
          {
            ...
            type: 'team',
            helpText:
              'Team to assign tasks to if not defined in a form or kapp.',
            initialValue: space.hasIn([
              'attributesMap',
              'Task Assignee Team',
              0,
            ])
          ...
          },
          {
            ...
            type: 'form',
            helpText:
              'Form used for collecting feedback throughout the portal.',
