...
import { fetchSources, fetchSource, fetchTaskCategories } from '../../../apis';
  ...
  categories && [
    {
      ...
      initialValue:
        workflow.sourceName || (workflowType === 'routines' ? '-' : ''),
      helpText:
    ...
    },
    {
      ...
      initialValue:
        workflow.sourceGroup || (workflowType === 'routines' ? '-' : ''),
      helpText:
    ...
    workflowType !== 'trees' && {
      ...
      initialValue: workflow.definitionId.replace(/^routine_(.*)$/, '$1') || '',
      helpText:
    ...
    },
    {
      ...
      type: 'text',
      required: false,
      initialValue: workflow.ownerEmail || '',
    },
    {
      name: 'status',
      label: 'Status',
      ...
      initialValue: workflow.status || 'Active',
      helpText:
    ...
    workflowType !== 'trees' && {
      ...
      label: 'Categories',
      type: 'select-multi',
      initialValue: (workflow.categories || List()).map(c => c.get('name')),
      options: categories
        .sortBy(c => c.get('name'))
    ...
    workflowType !== 'trees' && {
      ...
      initialValue: workflow.inputs || List(),
    },
    workflowType !== 'trees' && {
      name: 'outputs',
      label: 'Outputs',
      ...
      initialValue: workflow.outputs || List(),
    },
  ];
