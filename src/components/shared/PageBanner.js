...
const PageBannerBreadcrumbs = props => {
...
const PageBannerContainer = props => {
  const {
    hero = true,
    image = hero,
    center = false,
...
const PageBannerComponent = props => {
  const {
    parts,
    breadcrumbs,
    title,
  ...
  return (
    <>
      ...
      {(breadcrumbs || title || actions || meta || children) && (
        <PageBannerContainer {...props}>
          <PageBannerBreadcrumbs breadcrumbs={breadcrumbs} />
...
export const PageBanner = compose(
